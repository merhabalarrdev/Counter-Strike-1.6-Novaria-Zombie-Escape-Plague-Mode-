...
native novaria_register_extra_knife(const name[], const give[], const remove[], price);
...
public plugin_init()
{
	...
	novaria_register_extra_knife("Dragon Sword", "dragonsword_give", "dragonsword_remove", 60)
	...
	register_clcmd("dragonsword_give", "ClCmd_DragonSwordGive")
	register_clcmd("dragonsword_remove", "ClCmd_DragonSwordRemove")
}
...
public ClCmd_DragonSwordGive(id)
{
	get_dragonsword(id)
	return PLUGIN_HANDLED
}
public ClCmd_DragonSwordRemove(id)
{
